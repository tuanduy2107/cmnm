    ...
    <div className="min-h-screen flex flex-col md:flex-row">
      ...
      <div className="hidden md:block md:w-1/2 relative bg-[#0d3a4e]">
        ...
        <div className="absolute inset-0 flex flex-col justify-center items-center z-20 p-12 text-white">
          <h2 className="text-4xl font-bold mb-6">Tham gia cùng DOP</h2>
          <p className="text-xl text-center max-w-md">
            Đăng ký tài khoản để tham gia vào các hoạt động và theo dõi các dự án của chúng tôi
          </p>
        ...
        <div className="w-full max-w-md">
          ...
          <div className="text-center mb-8">
            ...
            <p className="mt-2 text-sm text-gray-600">
              Hoặc{" "}
              <Link href="/auth/login" className="font-medium text-[#1d84b1] hover:text-[#25a5dd]">
                ...
                <form onSubmit={handleRegister}>
                  <CardContent className="space-y-6 px-0">
                    ...
                    <div className="space-y-3">
                      ...
                      <Input id="confirmPassword" type="password" required className="h-12" />
                    </div>
                    <div className="flex items-center space-x-2">
                      ...
                      >
                        Tôi đồng ý với{" "}
                        <Link href="/terms" className="text-[#1d84b1] hover:text-[#25a5dd]">
                          điều khoản sử dụng
                        </Link>
                      </label>
                    </div>
