...
import '../components/HomePage/LienHeVoiChungToi';
...
const AboutUs = () => {
    ...
    return (
        <div>
            {/* credits to the writter Ch.Aditya */}
            <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 750 500" preserveAspectRatio="xMidYMax slice">
                ...
                <g id="scene2">
                    ...
                    <g id="hills2">
                        ...
                        <path id="h2-1" style={{ opacity: 0 }} d="M749.55,500V398.27l-38.48-6.67s-29.86,12.13-63,11.53-39.61-7.26-70.33-13.41-72.58,21.4-105.61,21.4-75.5-17.78-110.64-17.78c-24.85,0-90.08,20.12-110.82,18.48s-51.11-20.42-82-6.26S.47,409.26.47,409.26V500Z" fill="#1d1d3a" />
                    </g>
                </g>
                {/* Scene 3 */}
                <g id="scene3" style={{ visibility: 'hidden' }}>
                    ...
                    <g id="fstar">
                        <image width={707} height={429} transform="translate(728.46 16.5) scale(0.24)" xlinkHref="https://i.ibb.co/TWfhqRG/fstar.png" />
            ...
            <div className="relative flex flex-col w-screen">
                ...
                <div className="section" ref={(el) => (sectionsRef.current[1] = el)}>
                    <div className="items-center justify-center min-h-screen relative grid grid-cols-1 gap-4 lg:grid-cols-3 lg:gap-8">
                        <div className="h-96 ml-12 rounded-lg  flex flex-col items-center justify-center text-black">
                ...
                <div className="section" ref={(el) => (sectionsRef.current[5] = el)}>
                    <div className="flex flex-col items-center justify-center  min-h-screen relative">
                        <div className="text-4xl font-bold text-center mb-4">Về chúng tôi</div>
                        <div className="text-6xl font-bold text-center">Quan điểm và phương pháp giáo dục</div>
                    </div>
                </div>
